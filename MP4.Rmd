...
# insert Aladdin  originaland remake  images and plot side by side
...
**When looking at the market of the ‘original’ disney princesses, we notice that Cinderella was one of the oldest movies produced by the company and Beauty and the Beast one of  the highest grossing movies. Therefore, these are two potential reasons for why Disney detected potential for the success of their remakes and decided to start with them in releasing remakes.**
...
**Finally, the remake movies give more insight in to the stories of essential female characters. In both remakes of Cinderella and Beauty and the Beast, we learn about the stories of these princesses’ mothers and the reasons behind their deaths.** 
...
**We also find out more about the stepmother in Cinderella,allowing the viewers to understand how, in many ways, Cinderella’s stepmother  is a ‘prisoner in her own home’.**
...
![**Zoya Alam**](http://oi64.tinypic.com/dnokna.jpg){width=50%}
...
![**Zoya  Azhar**](http://oi64.tinypic.com/rkbfyf.jpg){width=50%}
